...
| -------------- | --------------------------- | --------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **P6-REQ-001** | Prize Ladder Component      | As a host/audience, I need to see prize values so that stakes are clear           | - Visual ladder from Rs.100 to Rs.64M<br>- Highlight current level (yellow/gold)<br>- Milestone markers (e.g., Q5, Q10, Q15)<br>- Responsive design (mobile/desktop)<br>- Animate on level change           |
...
| **P6-REQ-005** | Toast for Key Events        | As a host, I need notifications for important events so that I stay informed      | - Team eliminated: "Team X eliminated - Rs.Y"<br>- Team completed: "Team X won Rs.64M!"<br>- Lifeline used: "Phone-a-Friend activated"<br>- Question loaded: "Question ready"<br>- Connection lost/restored |
