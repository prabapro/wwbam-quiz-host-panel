...
| **P2-REQ-011** ✅ | Team Uploader Component     | As a host, I need to upload JSON files so that teams are synced with Firebase                     | - Drag & drop or file picker<br>- Real-time validation feedback<br>- Progress indicator<br>- Success/error messages<br>- Supports multiple uploads     |
| **P2-REQ-012** ✅ | Prize Management Page       | As a host, I need to manage prize structure so that I can customize prize values                  | - Navigate to /prizes<br>- View current Firebase structure<br>- Edit prize values<br>- Sync with Firebase<br>- Summary statistics                      |
| **P2-REQ-013** ✅ | Prize Structure Store       | As a host, I need prize state management so that changes are tracked before saving                | - Load from Firebase<br>- Track unsaved changes<br>- Validate prize structure<br>- Save/discard actions<br>- Persist to localStorage                   |
| **P2-REQ-014** ✅ | Prize Structure Editor      | As a host, I need to edit prize values so that I can customize the competition structure          | - Dual view modes (ladder/table)<br>- Add/remove prize levels<br>- Inline editing<br>- Validation errors display<br>- Save/reset/discard actions       |
| **P2-REQ-015** ✅ | Prize Structure Ladder View | As a host, I need a visual ladder view so that I can see prizes in game order                     | - Reverse order (highest first)<br>- Milestone highlighting<br>- Inline input fields<br>- Formatted display<br>- Visual hierarchy                      |
